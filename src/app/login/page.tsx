    ...
    <>
        ...
        <div className="container nav-inner">
          <a href="/" className="nav-logo" aria-label="HabaCasa home">
            <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "40px", height: "40px" }}>
              ...
              <defs>
                <linearGradient id="login-logo" x1="0" y1="0" x2="40" y2="40">
      ...
      <div className="auth-page">
        <div className="glass auth-card">
          <h1>Welcome back</h1>
          <p className="subtitle">Sign in to manage your smart space.</p>

          <button className="btn btn-google btn-sm" onClick={handleGoogle} disabled={loading} style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "0" }}>
